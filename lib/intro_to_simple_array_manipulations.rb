...
def using_unshift (neighborhood_in_northwest_brooklyn, new_neighborhood)
	neighborhood_in_northwest_brooklyn.unshift(new_neighborhood)
end

def using_pop (great_hit_of_the_nineties)
	great_hit_of_the_nineties.pop
end
